...
/*   Updated: 2019/03/01 17:47:52 by dde-jesu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const t_texture_animated	*weapons = &wolf->weapons_texture;
	...
	if (SDL_GetTicks() - weapons.last_seen > weapons.delay)
	{
		...
		{
			weapons.index = wolf->player.selected_weapon * weapons.step_count.x;
